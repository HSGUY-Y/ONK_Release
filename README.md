...
1. ***文件***<br>
   *文件选项卡，主要提供对 `.bin` 文件的`新建`、`打开`、`修改`、`保存`等操作。*<br>
    - *打开 `.bin` 文件；
      - 点击 `文件` -> `打开固件`*<br>
        <img src ="./screenshot/open_bin01.png" width="620"/>
      - 选择 `.bin` 文件；
        <img src ="./screenshot/open_bin02.png" width="620"/>
      - 浏览或编辑 `.bin` 文件。
        <img src ="./screenshot/open_bin03.png" width="620"/>
    - *保存 `.bin` 文件*<br>
      - 点击 `文件` -> `保存`（<kbd>Ctrl</kbd> + <kbd>S</kbd>）或 `文件` -> `另存为`（<kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>S</kbd>）均可保存文件。 
        <img src = "./screenshot/save_bin.png" width ="620" />
2. ***连接***<br>
   *连接选项卡，可用于不同设备的`链接`操作。*<br>
    - 点击 `连接` -> `串口`；
        <img src = "./screenshot/connect01.png" width = "620"/>
    - 选择 `串口号` 、 `波特率` 、`设备型号`；
        <img src = "./screenshot/connect02.png" width = "620"/>
    - 成功连接`指定设备`；
        <img src = "./screenshot/connect03.png" width = "620"/>
3. ***设置***<br>
...
### 导航栏&工作区
*导航栏包含应用各项功能的导航目录；其与工作区各项功能项相互连接，可通过点击目录导航至对应功能选项。*
